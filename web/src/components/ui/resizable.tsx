...
const ResizableHandle = ({
  ...
  >
    {withHandle && (
      <div className="z-10 flex h-4 w-3 items-center justify-center rounded-sm border border-stone-200 bg-stone-50 group-hover:bg-stone-100">
        <GripVertical className="h-2.5 w-2.5 text-stone-400" />
      </div>
    )}
  </ResizablePrimitive.PanelResizeHandle>
)
